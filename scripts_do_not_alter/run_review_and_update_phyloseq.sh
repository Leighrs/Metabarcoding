...
colnames(meta) <- trimws(colnames(meta))
  ...
  rank_cols <- c("Kingdom","Phylum","Class","Order","Family","Genus","Species","Common","ASV_sequence")
...
readme_lines <- c(
  ...
  "    - If you did not used a custom RSD, there will be no confidence column in your final phyloseq object."
